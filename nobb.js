...
$.zdUrl = 'http://api.turinglabs.net/api/v1/jd/bean/create/di27gmqvpegmgwrjd6avbhlatvdh45bdi57l2cy/'  // 种豆得豆
$.ncUrl = 'http://api.turinglabs.net/api/v1/jd/farm/create/0cd4803c42f046bab80f78c46488ab71/'  // 农场
$.mcUrl = 'http://api.turinglabs.net/api/v1/jd/pet/create/MTE1NDQ5OTIwMDAwMDAwNDE5MTM1NzU=/'  // 萌宠
$.ddUrl = 'http://api.turinglabs.net/api/v1/jd/ddfactory/create/P04z54XCjVWnYaS5uC1r7ZWbKjBPOoYrqxEBQ/'  // 东东工厂
//$.jxUrl = 'http://api.turinglabs.net/api/v1/jd/jxfactory/create/5HQ9oKVTP-LZ0u6U3cfqCA==/'  // 惊喜
